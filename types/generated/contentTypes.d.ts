...
export interface ApiPortfolioPagePortfolioPage extends Schema.CollectionType {
  collectionName: 'portfolio_pages';
  info: {
    singularName: 'portfolio-page';
    pluralName: 'portfolio-pages';
    displayName: 'PortfolioPages';
    description: '';
  };
  options: {
  ...
  attributes: {
    ...
    myRoles: Attribute.Component<'role-block.role-block', true>;
    preview: Attribute.Media<'images'>;
    linkLive: Attribute.String;
    linkFE: Attribute.String;
    linkBE: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
